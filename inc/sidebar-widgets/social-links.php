...
class Edumark_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'edumark_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Edumark ] Social Links', 'edumark-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'edumark-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'edumark-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'edumark-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'edumark-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'edumark-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'edumark-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'edumark-companion'); ?></label>
...
} // Class edumark_social_links ends here


// Register and load the widget
function edumark_social_links_widget_load() {
	register_widget( 'Edumark_social_links' );
}
add_action( 'widgets_init', 'edumark_social_links_widget_load' );