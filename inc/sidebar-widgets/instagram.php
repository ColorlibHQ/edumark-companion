...
----------------------------------------*/
class edumark_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('edumark_instagram_photo',esc_html__('[ Edumark ] Intagram Photo','edumark-companion'),array(
			'description' => esc_html__('Edumark Instagram Photo Widget','edumark-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'edumark-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'edumark-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'edumark-companion'); ?></label>
...
if(!function_exists('edumark_instagram_widgets')):
	function edumark_instagram_widgets(){
		register_widget('edumark_instagram_photo');
	}
	add_action('widgets_init','edumark_instagram_widgets');
endif;
