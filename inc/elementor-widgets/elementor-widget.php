...
if ( !class_exists( 'Edumark_El_Widgets' ) ) {
    ...
    final class Edumark_El_Widgets {
        ...
        public function __clone() {
            ...
            _doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'edumark-companion' ), '1.7.0' );
        }
        ...
        public function admin_notice_missing_main_plugin() {
            ...
            /* translators: 1: Elementor */
                esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'edumark-companion' ),
                '<strong>' . esc_html__( 'Edumark Theme', 'edumark-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'edumark-companion' ) . '</strong>'
            );
        ...
        public function admin_notice_minimum_elementor_version() {
            ...
            /* translators: 1: Elementor 2: Required Elementor version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'edumark-companion' ),
                '<strong>' . esc_html__( 'Edumark', 'edumark-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'edumark-companion' ) . '</strong>',
        ...
        public function admin_notice_minimum_php_version() {
            ...
            /* translators: 1: PHP 2: Required PHP version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'edumark-companion' ),
                '<strong>' . esc_html__( 'Edumark', 'edumark-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'PHP', 'edumark-companion' ) . '</strong>',
        ...
        public function add_elementor_category() {
            ...
            \Elementor\Plugin::instance()->elements_manager->add_category( 'edumark-elements', [
                'title' => __( 'Edumark Elements', 'edumark-companion' ),
            ], 1 );
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            // utility class
            wp_enqueue_style( 'edumark-companion-utility', plugins_url( 'assets/css/utility.css', __FILE__ ), array(), '1.0', 'all' );
            ...
            ******************/
            ...
            // map active js
            // wp_register_script( 'edumark-map-active', plugins_url( 'assets/js/map-active.js', __FILE__ ), array('jquery'), '1.0', true );
            // edumark companion main js
            wp_enqueue_script( 'edumark-companion', plugins_url( 'assets/js/edumark-companion-main.js', __FILE__ ), array( 'masonry', 'edumark-ui-js' ), '1.0-s2', true );
        ...
        public function register_widget_styles() {
            // Typing Effect
            wp_enqueue_style( 'edumark-companion-elementor-edit', plugins_url( '/assets/css/elementor-edit.css', __FILE__ ) );
        }
         ...
         *
         * Register custom styles required to Edumark Companion WordPress Admin Dashboard.
         *
         * @access public
         */
        ...
        private function include_widgets() {
            ...
            require_once EDUMARK_COMPANION_EW_DIR_PATH . 'widgets/hero-section.php';
        ...
        private function register_widgets() {
            ...
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Edumarkelementor\Widgets\Edumark_Hero() );
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Edumarkelementor\Widgets\Edumark_About_Us() ); 
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Edumarkelementor\Widgets\Edumark_Popular_Courses() ); 
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Edumarkelementor\Widgets\Edumark_Review_Contents() ); 
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Edumarkelementor\Widgets\Edumark_Course_Speciality() ); 
