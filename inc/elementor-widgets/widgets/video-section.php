...
/**
 *
 * Edumark elementor video section section widget.
 *
 * @since 1.0
 */
class Edumark_Video_Section extends Widget_Base {

	public function get_name() {
		return 'edumark-video-section';
	}

	public function get_title() {
		return __( 'Video Section', 'edumark-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'video_left_content',
            [
                'label' => __( 'Video Left Content', 'edumark-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'How We Work', 'edumark-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Book Now', 'edumark-companion' ),
            ]
        );
        $this->add_control(
            'btn_url',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Video Section', 'edumark-companion' ),
            ]
        );
        $this->add_control(
            'video_thumb',
            [
                'label' => esc_html__( 'Video Thumbnail', 'edumark-companion' ),
        ...
        $this->add_control(
            'video_url',
            [
                'label' => esc_html__( 'Popup Video URL', 'edumark-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default' => [
    ...
    $video_thumb    = !empty( $settings['video_thumb']['id'] ) ? wp_get_attachment_image( $settings['video_thumb']['id'], 'edumark_video_thumb_877x750', '', array( 'alt' => $sec_title.' image' ) ) : '';
